    ...
    def __init__(self):
        ...
        for i in range(4,5):
            for j in 'C#D#EF#G#A#B':
                if j == '#':
                    self.__notes.append(str(self.__notes[-1][0])+str(j)+str(i))
                else:
        ...
        self.__matrice_proba = {
            "C4": [0,0,0,1/7,1/7,1/7,0,1/7,1/7,1/7,0,0,1/7], 
            "C#4": [0,0,0,0,1/6,1/6,1/6,0,1/6,1/6,1/6,0,0], 
            "D4": [0,0,0,0,0,1/6,1/6,1/6,0,1/6,1/6,1/6,0],
            "D#4": [0,0,0,0,0,0,1/6,1/6,1/6,0,1/6,1/6,1/6],
            "E4": [1/6,0,0,0,0,0,0,1/6,1/6,1/6,0,1/6,1/6],
            "F4": [1/6,1/6,0,0,0,0,0,0,1/6,1/6,1/6,0,1/6],
            "F#4": [1/6,1/6,1/6,0,0,0,0,0,0,1/6,1/6,1/6,0],
            "G4": [0,1/6,1/6,1/6,0,0,0,0,0,0,1/6,1/6,1/6],
            "G#4": [1/6,0,1/6,1/6,1/6,0,0,0,0,0,0,1/6,1/6],
            "A4": [1/6,1/6,0,1/6,1/6,1/6,0,0,0,0,0,0,1/6],
            "A#4": [1/6,1/6,1/6,0,1/6,1/6,1/6,0,0,0,0,0,0],
            "B4": [0,1/6,1/6,1/6,0,1/6,1/6,1/6,0,0,0,0,0],
            "C5": [1/7,0,0,1/7,1/7,1/7,0,1/7,1/7,1/7,0,0,0]} # Notre matrice de transition qui depend des notes consonantes
